    ...
    public static class ObjectExtensions {
        ...
        public static void AddParam(this DbCommand cmd, object item) {
            ...
            else
            {
                ...
                if (item is string) p.Size = ((string) item).Length > 4000 ? -1 : 4000;
            }
        ...
        public static dynamic RecordToExpando(this IDataReader rdr) {
            ...
            for (var i = 0; i < rdr.FieldCount; i++)d.Add(rdr.GetName(i), DBNull.Value.Equals(rdr[i]) ? null : rdr[i]);
            return e;
        }
        /// <summary>
        ...
        public static dynamic ToExpando(this object o) {
            ...
            if (o.GetType() == typeof(NameValueCollection) || o.GetType().IsSubclassOf(typeof(NameValueCollection))) {
                ...
                foreach (var item in props)d.Add(item.Name, item.GetValue(o, null));
            }
            return result;
        }
        /// <summary>
    ...
    public class DynamicModel : DynamicObject {
        ...
        public virtual IEnumerable<dynamic> Query(string sql, params object[] args) {
            using (var conn = OpenConnection()) {
                ...
                while (rdr.Read())yield return rdr.RecordToExpando(); ;
            }
        }
        /// <summary>
        ...
        public virtual object Scalar(string sql, params object[] args) {
            object result;
            using (var conn = OpenConnection())result = CreateCommand(sql, conn, args).ExecuteScalar();
            return result;
        }
        /// <summary>
        ...
        public virtual DbCommand CreateDeleteCommand(string where = "", object key = null, params object[] args) {
            ...
            if (key != null) {
                ...
                args = new[] { key };
            } else if (!string.IsNullOrEmpty(where))sql += where.Trim().StartsWith("where", StringComparison.CurrentCultureIgnoreCase)? where : "WHERE " + where;
        ...
        public virtual dynamic Paged(string where = "", string orderBy = "", string columns = "*", int pageSize = 20, int currentPage = 1, params object[] args) {
            ...
            if (!string.IsNullOrEmpty(where))if (!where.Trim().StartsWith("where", StringComparison.CurrentCultureIgnoreCase))where = "WHERE " + where;
